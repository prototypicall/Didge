...
//General purpose timer
    ...
    namespace Tim4Smcr{    ///<slave mode control register
        using Addr = Register::Address<0x40000808,0xffff0008,0x00000000,unsigned>;
    ...
    namespace Tim4Ccmr2Output{    ///<capture/compare mode register 2 (output          mode)
        ...
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(12,12),Register::ReadWriteAccess,unsigned> oc4m_lsb{}; 
