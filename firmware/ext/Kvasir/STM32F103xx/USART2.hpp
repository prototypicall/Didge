...
//Universal synchronous asynchronous receiver      transmitter
    namespace Usart2Sr{    ///<Status register
        using Addr = Register::Address<0x40004400,0xfffffc00,0x00000000,unsigned>;
        ///CTS flag
    ...
    namespace Usart2Dr{    ///<Data register
        using Addr = Register::Address<0x40004404,0xfffffe00,0x00000000,unsigned>;
        ///Data value
    ...
    namespace Usart2Brr{    ///<Baud rate register
        using Addr = Register::Address<0x40004408,0xffff0000,0x00000000,unsigned>;
        ...
        // brr
        constexpr Register::FieldLocation<Addr,Register::maskFromRange(15,0),Register::ReadWriteAccess,unsigned> brr_12_4{}; 
    }
    namespace Usart2Cr1{    ///<Control register 1
        using Addr = Register::Address<0x4000440c,0xffffc000,0x00000000,unsigned>;
        ///USART enable
    ...
    namespace Usart2Cr2{    ///<Control register 2
        using Addr = Register::Address<0x40004410,0xffff8090,0x00000000,unsigned>;
        ///LIN mode enable
    ...
    namespace Usart2Cr3{    ///<Control register 3
        using Addr = Register::Address<0x40004414,0xfffff800,0x00000000,unsigned>;
    ...
    namespace Usart2Gtpr{    ///<Guard time and prescaler          register
        using Addr = Register::Address<0x40004418,0xffff0000,0x00000000,unsigned>;
        ///Guard time value
